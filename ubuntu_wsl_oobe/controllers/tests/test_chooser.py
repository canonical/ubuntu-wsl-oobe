...
from ubuntu_wsl_oobe.controllers.chooser import (
    RecoveryChooserController,
    RecoveryChooserConfirmController,
    )
from ubuntu_wsl_oobe.models.systems import (
...
class TestChooserConfirmController(unittest.TestCase):
    ...
    @mock.patch('ubuntu_wsl_oobe.controllers.chooser.ChooserConfirmView')
...
class TestChooserController(unittest.TestCase):
    ...
    @mock.patch('ubuntu_wsl_oobe.controllers.chooser.ChooserCurrentSystemView',
                return_value='current')
    @mock.patch('ubuntu_wsl_oobe.controllers.chooser.ChooserView',
                return_value='all')
